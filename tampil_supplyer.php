...
<script>
	...
	function delete_data(kode) {
		...
		if (pilih==true) {
			$.get('delete_supplyer.php?kode='+kode, null, function(data) {$('#data').html(data);});
